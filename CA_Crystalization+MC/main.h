...
extern Fl_Value_Input *input_MC;
extern Fl_Value_Input *input_kt;
int main();
void callback_hand();
...
extern Fl_Round_Button *btn_grains;
extern Fl_Round_Button *btn_energy;
extern Fl_Round_Button *btn_gr;
extern Fl_Round_Button *btn_en;
